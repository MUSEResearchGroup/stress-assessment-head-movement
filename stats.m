...
xlabel('Coordinata x (m)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per la coordinata x', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fx.Position = [1000 778 784 560];
%xlim([-3e-3 7e-3])
...
xlabel('Coordinata z (m)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per la coordinata z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fz.Position = [1000 778 784 560];
...
xlabel('Total Displacement (m)', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
ylabel('Test Phase', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
%title('HSD results for total displacement', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
set(gca, 'FontSize', 24, 'FontName', 'Century Gothic')
yticklabels(["Phase 3" "Phase 2" "Phase 1"])
f_disp.Position = [954 709 832 628];
...
for i = 1:length(ticklabels)
    ticklabels_new{i} = ['\color[rgb]{0.12,0.21,0.39}' ticklabels{i}];
end
% set the tick labels
...
% get the current tick labeks
ticklabels2 = get(gca,'XTickLabel');
% prepend a color for each tick label
ticklabels_new2 = cell(size(ticklabels2));
for i = 1:length(ticklabels2)
    ticklabels_new2{i} = ['\color[rgb]{0.12,0.21,0.39}' ticklabels2{i}];
end
% set the tick labels
set(gca, 'XTickLabel', ticklabels_new2);
...
xlabel('Coordinata x (m)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento lungo x', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fx.Position = [1000 778 784 560];
xlim([3.5e-4 11e-4])
...
xlabel('Coordinata y (m)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento lungo y', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fy.Position = [1000 778 784 560];
xlim([3.5e-4 11e-4])
...
xlabel('Coordinata z (m)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento lungo z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fz.Position = [1000 778 784 560];
xlim([3.5e-4 11e-4])
...
xlabel('Segno della coordinata x', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per il segno della coordinata x', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fx.Position = [1000 778 784 560];
...
xlabel('Segno della coordinata y', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per il segno della coordinata y', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fy.Position = [1000 778 784 560];
...
xlabel('Sign z coordinate', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Test Phase', 'FontSize', 18, 'FontName', 'Times New Roman')
title('HSD Results for sign z coordinate', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
fz.Position = [1000 778 784 560];
...
xlabel('Componente x della velocità (m/s)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per la componente x della velocità', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fx.Position = [1000 778 784 560];
...
xlabel('Componente y della velocità (m/s)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per la componente y della velocità', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fy.Position = [1000 778 784 560];
...
xlabel('Componente z della velocità (m/s)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per la componente z della velocità', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fz.Position = [1000 778 784 560];
...
xlabel('Speed (m/s)', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
ylabel('Test Phase', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
%title('Risultati HSD per la velocità', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
set(gca, 'FontSize', 24, 'FontName', 'Century Gothic')
yticklabels(["Phase 3" "Phase 2" "Phase 1"])
f.Position = [954 709 832 628];
...
xlabel('Angolo tra x e z (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''angolo tra x e z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fxz.Position = [1000 778 784 560];
%xlim([-0.1 0.02])

fyz=figure;
[c_yz_angle,m1_yz_angle,h_yz_angle,gnames_yz_angle] = multcompare(stats_angle_yz);
xlabel('Angolo tra y e z (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''angolo tra y e z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fyz.Position = [1000 778 784 560];
%xlim([-0.1 0.02])

fxy=figure;
[c_xy_angle,m1_xy_angle,h_xy_angle,gnames_xy_angle] = multcompare(stats_angle_xy);
xlabel('Angle between y e x (rad)', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
ylabel('Test Phase', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color', '#203864')
%title('Risultati HSD per l''angolo tra y e x', 'FontSize', 24, 'FontName', 'Century Gothic', 'Color','#203864')
set(gca, 'FontSize', 24, 'FontName', 'Century Gothic')
yticklabels(["Phase 3" "Phase 2" "Phase 1"])
fxy.Position = [954 709 832 628];
...
fxz = figure;
[c_xz_angle,m1_xz_angle,h_xz_angle,gnames_xz_angle] = multcompare(stats_angle_xz);
xlabel('Spostamento angolo tra x e z (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento angolare tra x e z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fxz.Position = [1000 778 784 560];
%xlim([0.08 0.22])
...
fyz=figure;
[c_yz_angle,m1_yz_angle,h_yz_angle,gnames_yz_angle] = multcompare(stats_angle_yz);
xlabel('Spostamento angolo tra y e z (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento angolare tra y e z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fyz.Position = [1000 778 784 560];
%xlim([0.08 0.22])
...
fxy=figure;
[c_xy_angle,m1_xy_angle,h_xy_angle,gnames_xy_angle] = multcompare(stats_angle_xy);
xlabel('Spostamento angolo tra y e x (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per l''entità dello spostamento angolare tra y e x', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fxy.Position = [1000 778 784 560];
%xlim([0.08 0.22])
...
fyz = figure;
[c_yz_angle,m1_yz_angle,h_yz_angle,gnames_yz_angle] = multcompare(stats_angle_yz);
xlabel('Segno dell''angolo tra y e z (rad)', 'FontSize', 18, 'FontName', 'Times New Roman')
ylabel('Fase Test', 'FontSize', 18, 'FontName', 'Times New Roman')
title('Risultati HSD per il segno dello spostamento angolare tra y e z', 'FontSize', 18, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 18, 'FontName', 'Times New Roman')
yticklabels(["Fase3" "Fase2" "Fase1"])
fyz.Position = [1000 778 784 560];
...
for i = 1:3
    y = i;
%     %ts = tinv([0.05  0.95],length(RT_data(:,i))-1);      % T-Score
%     conf = 0.95;
%     alpha = 1 - conf;
%     pLo = alpha/2;
%     pUp = 1 - alpha/2;
%     ts = tinv([pLo pUp], length(RT_data(:,i))-1);
%     %CI = ts*m_nonparam(i,2);                      % Confidence Intervals
%     CI = [-1.6896*m_nonparam(i,2) 1.6896*m_nonparam(i,2)];
%     limits(i,:) = CI+m_nonparam(i,1);
    if i == 1 
        color = [0 0 1 0.1];
    elseif i == 2 
        color = [1 0 0 0.1];
    ...
    rectangle('Position', [limits(i,1), 0, limits(i,2)-limits(i,1), 4], 'FaceColor', color, 'EdgeColor', [1 1 1])
    
%     line([limits(1), limits(1)], [0,4], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')
%     line([limits(2), limits(2)], [0,4], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')

    % da rifare facendo prima i rettangoli e sopra gli altri
    % il CI è nell'help di tinv
end
...
for i = 1:3
    ...
    hold on
    line(limits(i,:), [y, y], 'Color',color, 'LineWidth', 1.5)
    hold on
    stem(m_disp(i,1), y, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 7)
    hold on
    
    %line([limits(1), limits(1)], [0,6], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')
    %line([limits(2), limits(2)], [0,6], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')
...
% ylabel('Phase');
% Create xlabel
xlabel('Total Displacement (m)');
%xlim(axes1,[2 6.3]);
ylim(axes1,[0.5 3.5]);
% xlim(axes1,[0.012 0.034])
hold(axes1,'off');
set(axes1,'FontName','Times','FontSize',50,'YTick',[1,2,3]);
% f_disp.yticklabels = ["Phase 1" "Phase 2" "Phase 3"];
yticklabels(["Phase 1" "Phase 2" "Phase 3"])

%% GRAFICO VELOCITA TOTALE
figure
axes1 = axes;
hold(axes1,'on');
limits = [0.0133983 0.014771; 0.0120582 0.0130877; 0.0170285 0.0179608];
...
for i = 1:3
    ...
    line(limits(i,:), [y, y], 'Color',color, 'LineWidth', 1.5)
    hold on
    stem(m1_speed(i,1), y, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 7)
    hold on
...
axes1 = axes;
hold(axes1,'on');
limits = [0.0571967 0.0741796; 0.146563 0.159435; 0.0595937 0.0711404];
...
%         color = '#154734';
    ...
    line(limits(i,:), [y, y], 'Color',color, 'LineWidth', 1.5)
    hold on
    stem(m1_xy_angle(i,1), y, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 7)
    hold on
...
axes1 = axes;
hold(axes1,'on');
limits = [0.0772848 0.0940706; 0.085287 0.0980097; 0.0402194 0.0516321];
...
for i = 1:3
    ...
    line(limits(i,:), [y, y], 'Color',color, 'LineWidth', 1.5)
    hold on
    stem(m1_xz_angle(i,1), y, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 7)
    hold on
...
axes1 = axes;
hold(axes1,'on');
limits = [-0.118851 -0.104397; -0.0323126 -0.0213573; -0.0096481 0.000180571];
...
for i = 1:3
    ...
    line(limits(i,:), [y, y], 'Color',color, 'LineWidth', 1.5)
    hold on
    stem(m1_yz_angle(i,1), y, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 7)
    hold on
...
for i = 1:3
    ...
    line([y, y], limits(i,:), 'Color',color, 'LineWidth', 6)
    hold on
    h=stem(y, m1_speed(i,1), 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 20);
    hold on
    hbase = h.BaseLine; 
    hbase.Visible = 'off';
    %line([limits(1), limits(1)], [0,6], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')
...
%xlim(axes1,[2 6.3]);
xlim(axes1,[0.5 3.5]);
ylim(axes1,[0.012 0.018])
% xlim(axes1,[0.012 0.034])
hold(axes1,'off');
set(axes1,'FontName','Times','FontSize',80,'XTick',[1,2,3]);
% f_disp.yticklabels = ["Phase 1" "Phase 2" "Phase 3"];
xticklabels(["Phase 1" "Phase 2" "Phase 3"])
%% GRAFICO ANGOLO (X,Y)
fxy2=figure;
...
%         color = '#154734';
    ...
    line([y, y], limits(i,:), 'Color',color, 'LineWidth', 6)
    hold on
    stem(y, x, 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 20)
    hold on
...
ylabel('Angle (x,y) (rad)');
%xlim(axes1,[2 6.3]);
xlim(axes1,[0.5 3.5]);
ylim(axes1,[0.05 0.16]);
% xlim(axes1,[0.012 0.034])
hold(axes1,'off');
set(axes1,'FontName','Times','FontSize',80,'XTick',[1,2,3]);
% f_disp.yticklabels = ["Phase 1" "Phase 2" "Phase 3"];
...
for i = 1:3
    ...
    line([y, y], limits(i,:), 'Color',color, 'LineWidth', 6)
    hold on
    stem(y, m1_xz_angle(i,1), 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 20)
    hold on
...
for i = 1:3
    ...
    line([y, y], limits(i,:), 'Color',color, 'LineWidth', 6)
    hold on
    h=stem(y, m1_yz_angle(i,1), 'filled', 'LineStyle','None', 'MarkerFaceColor',color, 'MarkerEdgeColor', color, 'MarkerSize', 20);
    hold on
    hbase = h.BaseLine; 
    hbase.Visible = 'off';
    %line([limits(1), limits(1)], [0,6], 'LineWidth', 1,  'LineWidth', 0.5, 'Color', [100 100 100]/255, 'LineStyle', '--')
